...
export const words: Words = [
	...
	{ id: 72, word: '-ne', type: 'other', info: 'Fragepartikel (wird an Wort <angehängt>; habes<ne> = hast du?)' },
	...
	{ id: 91, word: '-que', type: 'other', translation: ['und'], info: 'an wort <angehängt> (z.B. Gaius<que>)' }
];
