...
function NavbarDropdown({ label, children, open, handleOpen, active }: NavbarDropdownProps) {
	return (
		<div className='flex justify-center my-auto'>
			<div
				className={`p-2 px-4 rounded-md font-semibold text-inherit border ${
			...
			{open === label && (
				<>
					...
					<div className='absolute z-50 mt-2 rounded-md text-center translate-y-10 border shadow bg-white'>
						{children}
					</div>
				</>
			)}
