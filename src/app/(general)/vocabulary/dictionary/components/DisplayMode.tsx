...
const DisplayMode = ({ view, setView }: DisplayModeProps) => {
	return (
		<div className='flex mr-2 mb-4 float-end'>
			<div
				className={`flex select-none cursor-pointer ${view === 'cards' ? 'text-blue-500' : 'text-gray-400'}`}
			...
			<div
				className={`flex select-none cursor-pointer ${view === 'list' ? 'text-blue-500' : 'text-gray-400'}`}
